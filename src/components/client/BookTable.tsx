...
interface Props {
  data: RouterOutputs["book"]["fetchBooks"];
  pageCount?: number;
}
const BookTable = (props: Props) => {
  ...
  const getBooks = api.book.fetchBooks.useQuery();

  const columns: ColumnDef<RouterOutputs["book"]["fetchBooks"][number]>[] = [
    // {
    //   accessorKey: "id",
    // header: ({ column }) => {
    //   return (
  ...
  return (
    <div className="w-full font-mono dark:text-white">
